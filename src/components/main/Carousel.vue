...
.containerx {
    ...
    width: 80%; /* Tamaño ajustado según tus necesidades */
    height: 500px; /* Tamaño ajustado según tus necesidades */
    margin: 0 auto; /* Centrado horizontalmente */
    background: #000;
    box-shadow: 1px #dbdbdb;
    overflow: hidden;
  }
...
@media (max-width: 768px) {
    ...
    top: 5px;
    position: relative; /* Cambiado a posición relativa */
    width: 85%; /* Tamaño ajustado según tus necesidades */
    height: 450px; /* Tamaño ajustado según tus necesidades */
    margin: 0 auto; /* Centrado horizontalmente */
...
export default {
  mounted() {
    // JavaScript para el Carousel (puedes mover esto al método created o mounted)
    ...
    prev.addEventListener('click', function(){
        let items = document.querySelectorAll('.item');
        document.querySelector('.slide').prepend(items[items.length - 1]); // aquí la longitud de items = 6
    });
  }
};
</script>
